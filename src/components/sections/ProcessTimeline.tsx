    ...
    <div className="container">
      ...
      <div className="timeline">
        <TimelineStep
          ...
          imageSrc={`${import.meta.env.BASE_URL}images/pablo-merchan-montes-SCbq6uKCyMY-unsplash.jpg`}
        ...
        <TimelineStep
          ...
          imageSrc={`${import.meta.env.BASE_URL}images/macarena-navarro-br-BVH65K78-unsplash.jpg`}
        ...
        <TimelineStep
          ...
          imageSrc={`${import.meta.env.BASE_URL}images/tina-guina-obV_LM0KjxY-unsplash.jpg`}
        ...
        <TimelineStep
          ...
          imageSrc={`${import.meta.env.BASE_URL}images/vonvix-36IX3vlzqds-unsplash.jpg`}
